        ...
        {isOpen && (
          <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              onClick={handleClose} className="fixed inset-0 bg-foreground/20 backdrop-blur-sm z-50" />
            <motion.div
                ...
                {isSuccess ? (
                  ...
                  <>
                    ...
                    <div className="bg-secondary rounded-2xl px-4 py-4 mb-4 space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-foreground/60 mt-0.5 leading-relaxed">Vul het korte intakeformulier in zodat Studio Luna je goed kan begeleiden.</p>
                        </div>
                      </div>
                    ...
                    <button onClick={handleConfirm} disabled={isSubmitting}
                      ...
                      {isSubmitting ? spinner : "Proefles reserveren"}
                    </button>
                  </>
                  ...
                  <>
                    ...
                    <div className="bg-secondary rounded-2xl px-4 py-4 mb-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-foreground/60 mt-0.5 leading-relaxed">Losse les: <span className="font-semibold">€ 22,50</span>. Je betaalt contant of via Tikkie bij aankomst.</p>
                      </div>
                    </div>
                    {error && <p className="text-sm text-red-500 mb-4">{error}</p>}
                    <button onClick={handleConfirm} disabled={isSubmitting}
