        ...
        <div className="px-6 md:px-12 lg:px-16 pt-8 space-y-3">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.07 }}
            ...
            <button onClick={() => openRequest("losse_les")}
              className="w-full flex items-center justify-center gap-2 border border-primary/40 text-primary py-2.5 rounded-2xl font-semibold text-sm hover:bg-primary/5 transition-colors">
              Losse les aanvragen
              <ArrowRight className="w-3.5 h-3.5" />
            </button>
          </motion.div>
