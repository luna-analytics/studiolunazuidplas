...
export const ZORGKAART: ZorgCategorie[] = [
  ...
  },
  {
    ...
    aanbieders: [
      {
        naam: "L&V Liefde en Vertrouwen",
        plaats: "Capelle aan den IJssel (aan huis in onder meer gemeente Zuidplas)",
        website: "https://lkliefdeenvertrouwen.nl/",
        beschrijving: "Gecertificeerde lactatiekundige praktijk in Capelle aan den IJssel met een avondcursus borstvoeding voor zwangeren en hun partners in kleine groepen en met consulten aan huis in onder meer gemeente Zuidplas, Rotterdam en Gouda.",
        tags: ["op-locatie", "aan-huis", "groepslessen", "1-op-1", "partner-welkom", "avond-weekend", "vergoeding"],
      },
      {
